...
function setupEventListeners() {
    ...
    // Direct event listener for top header/toolbar submit button
    ...
    // GLOBAL DELEGATION FOR OTHER SUBMIT / EXIT TRIGGERS
    document.addEventListener("click", (e) => {
        const submitTarget = e.target.closest(".submit-exam-btn, #submit-exam-btn, [data-action='submit-paper']");
        if (submitTarget) {
            e.preventDefault();
            e.stopPropagation();
            handleSubmitPaper();
